          ...
          <div class="flex items-stretch gap-3">
            ...
            >
              ...
              >
                ...
                >
                  <div
                    class="news-card__image w-full h-64 md:w-1/3 md:h-auto relative overflow-hidden shrink-0"
                  >
                    <NuxtImg
                      v-if="item.image"
                      :src="item.image"
                    ...
                    >
                      ...
                      />
                      <span class="font-minecraft text-xs text-white"
                  ...
                  <div class="flex flex-col gap-4 p-6 flex-1">
                    <div class="flex items-center gap-3">
                      ...
                      <span
                        class="font-minecraft text-xs text-white/40 text-shadow-mc"
                      >
                        {{ item.date }}
                      </span>
                    </div>
                    ...
                    <div class="flex flex-col gap-2 flex-1">
                      <h3
                        class="font-minecraft text-xl text-white text-shadow-mc leading-snug"
                      >
                        {{ item.title }}
                      </h3>
                      <p
                        class="font-minecraft text-sm text-white/65 leading-relaxed"
                      >
                        {{ item.description }}
                      </p>
                    </div>
